...
args = {
    ...
    'train_feather_path': './Data/Fashion-MNIST-test/fashion-mnist-test-clip-b16-noise/fashion-mnist-test_semi_supervise.feather',
...
use_clean = False  # đặt True để chạy
...
if use_clean:
    ...
    df = df.rename(columns={args['train_label_column']: 'label'})
